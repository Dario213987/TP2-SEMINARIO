{assign var="titulo" value="Editar autor"}
    ...
    <div class="card shadow-lg rounded-4">
        ...
        <form id="form-editar-autor" class="p-4" method="POST" enctype="multipart/form-data" action="/gestion/autores/modificar">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control {if $errors&&!empty($errors["nombre"])}is-invalid{/if}" name="nombre" placeholder="Nombre completo del autor" value="{$oldValues['titulo']|default:$autor->nombre}">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control {if $errors&&!empty($errors["biografia"])}is-invalid{/if}" name="biografia" placeholder="Introduzca la biografia del autor...">{$oldValues["sinopsis"]|default:$autor->biografia}</textarea>
